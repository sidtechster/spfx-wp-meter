    ...
    this.domElement.innerHTML = `
      <div class="${ styles.meter }">
        ...
        <svg width="100%" height="100%" viewBox="0 0 42 42" class="donut">
          ...
          <circle class="donut-segment" cx="21" cy="21" r="15.91549430918954" fill="transparent" stroke="#0066ff" stroke-width="3" stroke-dasharray="${this.properties.percentage} ${100 - this.properties.percentage}" stroke-dashoffset="0"></circle>
